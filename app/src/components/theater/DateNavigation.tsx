...
const DateNavigation: React.FC = () => {
  ...
  return (
    <div className="flex items-center space-x-2 justify-start overflow-x-auto bg-white p-4 rounded w-full border-b-2 border-gray-300 shadow-md sm:p-2 sm:space-x-1">
      {/* Month label */}
